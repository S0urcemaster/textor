	...
	return (
		<div
			style={{
				...
				width: '100%',
				display: 'flex',
				background: `linear-gradient(to top, ${colors.editorBackgroundLoLight}, ${colors.editorBackgroundHiLight})`,
				color: colors.editorColorLight,
			...
			>
				...
				<textarea
					...
					style={{
						...
						color: 'transparent',
						caretColor: colors.editorColorLight,
						boxSizing: 'border-box',
						fontFamily: editor.fontFamily,
						fontSize: editor.fontSize,
						lineHeight: editor.lineHeight,

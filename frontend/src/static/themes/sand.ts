...
const theme: Settings = {
	colors: {
		...
		editorHashtagColorLight: "#96d7ffff",
		editorHashtagColorDark: "#96d7ffff",
		editorAttagColorLight: "#96d7ffff",
		editorAttagColorDark: "#96d7ffff",
		effectEditorColorLight: '#f4d39eff',
		effectEditorColorDark: '#ffe6c2ff',
		...
		materialHi: 'rgb(204, 192, 138)',
		materialLo: 'rgb(160, 143, 105)',
		mezzoDark: '#696e7eff',
		red: '#a43434ff',
		blue: '#3457a4ff',
		blueAccent: "#96d7ffff",
